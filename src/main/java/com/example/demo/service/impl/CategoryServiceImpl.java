...
import com.example.demo.responsitory.ICategoryResponstiory;
import com.example.demo.service.CategoryService;

@Service
public class CategoryServiceImpl implements CategoryService {
	@Autowired
	private ICategoryResponstiory responstiory;

	public CategoryServiceImpl(ICategoryResponstiory responstiory) {
		super();
